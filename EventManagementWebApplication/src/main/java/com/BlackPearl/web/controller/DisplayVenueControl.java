...
/**
 * Servlet implementation class DisplayVenueControl
 */
public class DisplayVenueControl extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DisplayVenueControl() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    try {	
	      ...
	      if(rs.next()) {
	    	  	response.sendRedirect("a_decoration.jsp?vid="+rs.getInt("vid"));
