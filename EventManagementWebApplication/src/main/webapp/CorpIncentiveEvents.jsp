	...
	<div class="typo">
		<div class="container">
			<h2 class="heading-agileinfo">
				Corporate Incentives and Team Building Activities<span>Community affairs and integrated events</span>
			</h2>
			<div class="grid_3 grid_4 w3layouts" align="center">

				<iframe src="corporateIncentiveEventIframe.jsp" style="height: 1000px;; width: 100%"></iframe>
			</div>
		</div>
