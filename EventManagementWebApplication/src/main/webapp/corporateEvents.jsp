		...
		<div class="container">
			...
			<div class="grid_3 grid_4 w3layouts" align="center">
				<h2 class="heading-agileinfo">
					Corporate Events<span>Let our advance worrying become advance thinking and planning.</span>
				</h2>
				<div align="center">
			<p> Maximize shareholder value. Impress your guests. Make sure your event stands out from the crowd. Whether you're planning a conference, team-building event or holiday party, Black Pearl Events expertly creates and executes each corporate event to fit your organization's unique personality, customer profile and image.</p>  <br> <br>

<p>By truly understanding a company's vision and needs, we deliver brand-building memories from start to finish. From selecting vendors and managing budgets to integrating your brand throughout every detail, we work on your behalf to find out what's most important and how to bring those elements to life. That's why the nation's top corporations, foundations and professional associations depend on Black Pearl Events for building experiences that leave a lasting impression. </p></div>
				<br> <br>
				<table>
					<tr>
						<td>
							...
							<div class="containerimg">
								<a href="CorpConferenceEvents.jsp"> <img src="images/conference.jpg"
									alt="Conferences" style="width: 100%;"></a>
								<div class="contentimg">
									<h1>
										<a href="CorpConferenceEvents.jsp" style="color: white">Conferences and Product Launch</a>
									</h1>
								</div>
						...
						<td>
							<div class="containerimg">
								<a href="CorpTradeshowEvents.jsp"><img src="images/exhibition.jpg" alt="Trade Show" style="width: 100%;"></a>
								<div class="contentimg">
									<h1><a href="CorpTradeshowEvents.jsp" style="color: white">Trade Shows And Exhibitions</a></h1>
								</div>
							</div>
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<div class="containerimg">
								<a href="CorpIncentiveEvents.jsp"><img src="images/incentive.jpg" alt="Incentive" style="width: 100%;"></a>
								<div class="contentimg">
									<h1><a href="CorpIncentiveEvents.jsp" style="color: white">Corporate Incentives and Team Building Activities</a></h1>
								</div>
							</div>
						</td>
