...
int numberOfguests=Integer.parseInt(request.getParameter("nog"));
...
try {	
   ...
   String query="update venue set vname='"+vname+"' , address='"+address+"', hallno='"+hallno+"', type='"+type+"', numberOfguests='"+numberOfguests+
    		"' , price='"+price+"' where vid="+vid+"";
