...
<html lang="en">
<head>
<title>Black Pearl Event Management-Signin</title>
<meta charset="UTF-8">
...
<body>
	<!-- --------------------------------------------------------------------------------------------------------------- -->
	<div style="height: 80px; width: auto; background: #031736">
		<button onclick="location.href ='index1.jsp'">
			<font color="white"><b><br>&nbsp;&nbsp;<img
					src="images1/arrow.png" width="20" height="20">&nbsp;&nbsp;&nbsp;&nbsp;Back
					to Home Page</b></font>
		</button>
	</div>
		...
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" action="LoginControl"
					...
					<span class="login100-form-title p-b-26"> <font
						color="#5E93E4">Welcome</font> <br> <font size="3">Please
							Login Here</font>
					</span> <br> <br> <br>
					<div class="wrap-input100 validate-input"
						data-validate="Valid email is: a@b.c">
						<input class="input100" type="text" name="uname"> <span
					...
					<div class="wrap-input100 validate-input"
						...
						</span> <input class="input100" type="password" name="upass"> <span
