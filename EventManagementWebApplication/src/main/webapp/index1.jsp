...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
						...
						<div class="w3layouts-banner-top">
							...
							<div class="container">
								<div class="agileits-banner-info">
									<h3>
										We Celebrate <span>Birthday Parties</span>
									</h3>
					...
					<li>
						<div class="w3layouts-banner-top w3layouts-banner-top1">
							<div class="container">
								<div class="agileits-banner-info">
									<h3>
										We Celebrate <span>Newyear Parties</span>
									</h3>
									<p>Lorem Ipsum has been the industry's standard dummy text
										ever since the 1500s, when an unknown printer took.</p>
									<div class="agileits_w3layouts_more menu__item">
					...
					<li>
						<div class="w3layouts-banner-top w3layouts-banner-top2">
							<div class="container">
								<div class="agileits-banner-info">
									<h3>
										We Celebrate <span>Marriage Functions</span>
									</h3>
									<p>Lorem Ipsum has been the industry's standard dummy text
										ever since the 1500s, when an unknown printer took.</p>
									<div class="agileits_w3layouts_more menu__item">
			...
			<div class="container">
				<div class="navbar-header page-scroll">
					...
					<table>
							<tr>
								<td>
									<a class="navbar-brand" href="index1.jsp"><img src="images/logo1.png" width="50" height="50"></a>
								</td>
								<td>
									<h1>
										<a class="navbar-brand" href="index1.jsp">Black Pearl Events</a>
									</h1>
								</td>
							</tr>
						</table>
					...
					<ul class="nav navbar-nav navbar-right">
						...
						<li class="dropdown"><a href="#"
							...
							<ul class="dropdown-menu">
								<li><a class="hvr-sweep-to-right" href="signin.jsp">Wedding
										Events</a></li>
								<li><a class="hvr-sweep-to-right" href="signin.jsp">Corporate
										Events</a></li>
								<li><a class="hvr-sweep-to-right" href="signin.jsp">Non-profit
										Events</a></li>
								<li><a class="hvr-sweep-to-right" href="signin.jsp">Other
										Events</a></li>
							</ul></li>
						...
						<li class="dropdown"><a href="#" data-hover="Pages"
							data-toggle="dropdown"><img src="images/user.png" width="30"
								height="30"></a>
							<ul class="dropdown-menu">
								<li><a class="hvr-sweep-to-right" href="signin.jsp">signin</a></li>
								<li><a class="hvr-sweep-to-right" href="signup.jsp">signup</a></li>
							</ul></li>
	...
	<div class="ser_agile">
		<div class="container">
			<h2 class="heading-agileinfo">
				Welcome<span>Events is a professionally managed Event</span>
			</h2>
			<p>Masagni dolores eoquie int Basmodi temporant, ut laboreas
				dolore magnam aliquam kuytase uaeraquis autem vel eum iure
				reprehend.Unicmquam eius, Basmodi temurer sehsMunim.Masagni dolores
				eoquie int Basmodi temporant, ut laboreas dolore magnam aliquam
				kuytase uaeraquis autem vel eum iure reprehend.</p>
			<div class="ser_w3l">
	...
	<div class="stats-agileits">
		<div class="container">
			<h3 class="heading-agileinfo white-w3ls">
				We Have Something To Be Proud Of<span class="black-w3ls">Events
					is a professionally managed Event</span>
			</h3>
		</div>
		<div class="stats-info agileits w3layouts">
			<div class="container">
				<div
					class="col-md-4 col-sm-4agileits w3layouts stats-grid stats-grid-1">
					<i class="fa fa-users" aria-hidden="true"></i>
					<div class="numscroller agileits-w3layouts" data-slno='1'
						data-min='0' data-max='2500' data-delay='3' data-increment="2">2500</div>
					<div class="stat-info-w3ls">
						<h4 class="agileits w3layouts">Happy Clients</h4>
					</div>
				</div>
				<div
					class="col-md-4 col-sm-4 agileits w3layouts stats-grid stats-grid-2">
					<i class="fa fa-lightbulb-o" aria-hidden="true"></i>
					<div class="numscroller agileits-w3layouts" data-slno='1'
						data-min='0' data-max='1000' data-delay='3' data-increment="2">1000</div>
					<div class="stat-info-w3ls">
						<h4 class="agileits w3layouts">Events</h4>
					</div>
				</div>
				<div
					class="col-md-4 col-sm-4 stats-grid agileits w3layouts stats-grid-3">
					<i class="fa fa-cog" aria-hidden="true"></i>
					<div class="numscroller agileits-w3layouts" data-slno='1'
						data-min='0' data-max='3421' data-delay='3' data-increment="2">3421</div>
					<div class="stat-info-w3ls">
	...
	<div class="showcase_w3layouts">
		<div class="container">
			<h3 class="heading-agileinfo">
				Services<span>Events is a professionally managed Event</span>
			</h3>
				...
				<div class="showcase">
					...
					<div class="desc">
						...
						<p>Lorem ipsum dolor sit amet, consetetur sadipscing elitr,
							sed diam nonumy eirmod tempor invidunt ut l</p>
					</div>
				</div>
	...
	<section class="about_agile">
		<div class="container">
			<h3 class="heading-agileinfo white-w3ls">
				Event Booking<span class="black-w3ls">Events is a
					professionally managed Event</span>
			</h3>
						...
						<form action="#" method="post">
							<div class="col-sm-4 col-xs-4 w3ls-lt-form">
								<div class="w3ls-pr">
									...
									</select> <input type="text" name="Name" placeholder="Name">
								</div>
							</div>
							<div class="col-sm-4 col-xs-4 w3ls-lt-form">
								<div class="w3ls-pr">
									<input type="date" name="date" required="required"> <input
										type="tel" name="phone no" placeholder="Phone no"
										required="required">
								</div>
							</div>
							<div class="col-sm-4 col-xs-4 w3ls-lt-form">
								<div class="w3ls-pr">
									<input type="time" name="time" required="required"> <input
	...
	<div class="testimonials">
		<div class="container">
			<h3 class="heading-agileinfo">
				Event Manager Says<span>Events is a professionally managed
					Event</span>
			</h3>
