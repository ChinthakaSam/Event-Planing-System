	...
	<div class="typo">
		<div class="container">
			<h2 class="heading-agileinfo">
				Conferences and Product Launch<span>Innovative concepts, creative design, flawless execution.</span>
			</h2>
			<div class="grid_3 grid_4 w3layouts" align="center">

				<iframe src="corporateConferenceEventIframe.jsp" style="height: 1000px;; width: 100%"></iframe>
			</div>
		</div>
